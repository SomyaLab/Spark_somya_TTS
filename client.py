...
LANGUAGE_EXAMPLES = {
    "hi": "नमस्ते, आप कैसे हैं, आज का दिन आपके लिए कैसा बीत रहा है और सब कुछ ठीक तो है?",
    "kn": "ಲಕ್ಷ್ಮೀ ಇಂದು ಸಾಕಷ್ಟು ಹಾಲು ಕೊಟ್ಟಳು, ಅದನ್ನು ನೋಡಿ ಮನೆಮಂದಿಗೆ ತುಂಬಾ ಸಂತೋಷವಾಗಿದ್ದು ದೇವರಿಗೆ ಧನ್ಯವಾದ ಹೇಳಿದರು.",
    "bh": "ई एक ठोस परीक्षण बा, जवना से साफ़ पता चलत बा कि प्रयोग सही तरीका से कइल गइल बा।",
    "mr": "शेजारी त्याची मनापासून स्तुती करीत होता, कारण त्याने सगळ्यांच्या मदतीला वेळेवर हातभार लावला.",
    "mai": "की अहाँसभ नव छात्रसभ केँ सेहो छात्रवृत्ति दैत छी, जाहि सँ गरीब परिवारक विद्यार्थी पढ़ाई जारी रखि सकथि?",
    "mag": "मौसम विज्ञान के पढाई गणेशबा एही से कैले हय कि ऊ खेती आउ पर्यावरण के बारे में गहिरा समझ चाह रहल हय।",
    "gu": "એણે બધાની સામે સ્મિત સાથે ‘નમસ્તે’ કહ્યું અને પછી વાતચીત શરૂ કરી.",
    "bn": "গত চব্বিশ ঘণ্টায় একটানা বৃষ্টি হয়েছে, মোট পরিমাণ ছিল একত্রিশ মিলিমিটার, যার ফলে তাপমাত্রা কিছুটা কমেছে।",
    "hne": "अत्या पात्य ह एकठन पारंपरिक भारतीय टैग खेल हरय, जेन ला बचपन म गाँव के मैदान म सब मिलके खेलथें।"
}
